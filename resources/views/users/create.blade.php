...
<div class="row mb-3">
    <div class="col-sm-10">
        <span class="fs-4 fw-semibold">New User</span>
    </div>
...
<div class="mb-3">
    <label for="e-name" class="form-label">E-mail</label>
...
<div class="mb-3">
    <button type="submit" class="btn btn-danger"><i class="fa-solid fa-circle-plus"></i> Create User</button>
</div>
{!! Form::close() !!}
